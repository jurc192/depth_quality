...
def capture_depthmaps_csv(width=848, height=480, exposure=8500, laser_power=150, depth_preset=1, nframes=1):
...
if __name__ == "__main__":
    ...
    #     for lpow in lpowers:
    for i in range(1000):
        print(f"Capturing {i}-th set of 50 frames")
        while True:
            args = {'width': 848, 'height': 480, 'exposure': exp, 'laser_power': lpow, 'depth_preset': 1, 'nframes': nframes}
